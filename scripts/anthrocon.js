...
/**
* Our Anthrocon class, with specific functions.
*
...
*/
Anthrocon.prototype.serialize = function(data) {
...
*/
Anthrocon.prototype.get_status = function() {
...
*
* @param obj ac The Anthrocon object.  This is passed in so that we can
*	address the status array.
*
* @param obj e The HTML entity.  Equivilient to "this" in jQuery.
*/
Anthrocon.prototype.toggle_menu = function(ac, e) {
...
*/
Anthrocon.prototype.title_collapse = function(title) {
	var image = directory + "/images/menu/menu_arrow_collapsed.gif";
...
* @param object title Our title entity.
*/
Anthrocon.prototype.title_expand = function(title) {
	var image = directory + "/images/menu/menu_arrow_expanded.gif";
	title.css("background-image", "url(" + image + ")");
	title.css("background-position", "5px 50%");
	title.css("background-repeat", "no-repeat");
} // End of title_expand()
